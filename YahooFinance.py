...
class TickerInfo:
    ...
    def get_last_2years_performance(self, quantity, avg_cost_basis, purchased_date):
        ...
        row={
                ...
                'current_cost': quantity * data['Close'].min(),
            }
        ...
        row={
                ...
                'current_cost': quantity * data['Close'].max(),
            }
        period_perf_df=pd.concat([period_perf_df, pd.DataFrame([row])], ignore_index=True)
        ...
        row={
                ...
                'current_cost': quantity * self.get_current_price(),
            }
        period_perf_df=pd.concat([period_perf_df, pd.DataFrame([row])], ignore_index=True)
        """
        ...
        row={
                ...
                'current_cost': quantity * data['Close'].iloc[-1],
            }
        period_perf_df=pd.concat([period_perf_df, pd.DataFrame([row])], ignore_index=True)
        ...
        row={
                ...
                'current_cost': quantity * data['Close'].iloc[-2],
            }
        period_perf_df=pd.concat([period_perf_df, pd.DataFrame([row])], ignore_index=True)
        ...
        row={
                ...
                'current_cost': quantity * data['Close'].iloc[0],
            }
        period_perf_df=pd.concat([period_perf_df, pd.DataFrame([row])], ignore_index=True)
        ...
        period_perf_df=pd.concat([period_perf_df, pd.DataFrame([row])], ignore_index=True)
        self.yr1_min_price = data['Close'].min()
        self.yr1_max_price = data['Close'].max()
